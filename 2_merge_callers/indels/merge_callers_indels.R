...
deepvariant = fread(paste0("./inputs/Deepvariant/",ids[q],"/",ids[q],"_",chrm,"_indels.vcf"))
...
gatk = fread(paste0("./inputs/GATK/",ids[q],"/",ids[q],"_indel_",chrm,"_indels.vcf"))
...
strelka = fread(paste0("./inputs/Strelka2/",ids[q],"/",ids[q],"_",chrm,"_indel.vcf_norm.gz_indels.vcf"))
