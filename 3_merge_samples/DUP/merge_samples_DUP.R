...
while(n_row==0 & sample_initial<786){
  ...
  sample1 = fread(paste0("/gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_callers/",
                         ids[sample_initial],"/regenotype/",ids[sample_initial],"_Dup_chr_",chr,"_regenotype"),
                  header = T,fill = T)
  
  sample1[,3]=sample1[,15]
  sample1 = sample1[which(sample1[,3]!="0/0"),]
  sample1 = sample1[,1:14]
  ...
  if(n_row>0){
    ...
    my_samples1$ID = paste0("duplication_",1:nrow(my_samples1))
...
dir.create("/gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT//Duplicaciones/merge_samples_new/empty_batches/")

if(sample_initial==786){write.table(region_out[batch_job,],paste0("/gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_samples_new/empty_batches/chr_",chr,"_start_",start,"_end_",end),row.names=F,quote=F)
}
...
if(sample_initial<786){
  ...
  for(sample_merge in sample_initial:785){
    ...
    sample1 = fread(paste0("/gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_callers/",
                           ids[sample_merge],"/regenotype/",ids[sample_merge],"_Dup_chr_",chr,"_regenotype"),
                    header = T,fill = T)
  ...
  dir.create(paste0("/gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_samples_new/chr_",chr))
  
  final_merge %>% 
    fwrite(paste0("/gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_samples_new/chr_",chr,
                  "/Dup_chr_",chr,"_",as.character(start),"_",as.character(end)),row.names=F,sep=" ",na = "NA")
  
  print("Now compress pleaseeeeeeeeeeeeeeee")
  
  system(paste0("gzip /gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_samples_new/chr_",chr,
                "/Dup_chr_",chr,"_",as.character(start),"_",as.character(end)))
  
  print("Now generate VCF")
  
  final_merge = fread(paste0("zcat /gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_samples_new//chr_",chr,
                             "/Dup_chr_",chr,"_",as.character(start),"_",as.character(end),".gz"))
  ...
  final_merge2$SVTYPE = paste0("SVTYPE=DUP;")
  ...
  my_vcf$ID = paste0(chr,":",my_vcf$POS,":A:<DUP>")
  my_vcf$REF = "A"
  my_vcf$ALT = "<DUP>"
  ...
  fwrite(my_vcf,paste0("/gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_samples_new/chr_",chr,
                                       "/Dup_chr_",chr,"_",as.character(start),"_",as.character(end),".vcf"),row.names=F,sep="\t")
  
  print("Now compress again pleaseeeeeeeeeeeeeeee")
  
  
  system(paste0("gzip /gpfs/projects/bsc05/jordivalls/GCAT_project_all_samples/merge_all_calling_GCAT/Duplicaciones/merge_samples_new/chr_",chr,
                "/Dup_chr_",chr,"_",as.character(start),"_",as.character(end),".vcf"))
